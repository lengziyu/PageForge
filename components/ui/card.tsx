...
const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3 className={cn("text-lg font-semibold tracking-tight", className)} ref={ref} {...props} />
  ),
);
...
>(({ className, ...props }, ref) => (
  <p className={cn("text-sm text-[var(--muted-foreground)]", className)} ref={ref} {...props} />
));
CardDescription.displayName = "CardDescription";

const CardContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => <div className={cn("p-5 pt-0", className)} ref={ref} {...props} />,
);
